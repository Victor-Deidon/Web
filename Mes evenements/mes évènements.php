...
<html>
    ...
    <body>
		...
		<span style="float:left;"><h2>évènements que j'ai créé</h2>
                    ...
                    WHERE fichier_multimedia.ordre=1 
	...
	<span style="float:right;"><h2>évènements que j'ai rejoints</h2>
                    ...
                    WHERE fichier_multimedia.ordre=1
                    AND suis_invite_participe_signale.type=3 
                ...
                <p id="imagemarge"><a href="evenement.php" class="myButton">voir l'évènement</a></p><p>
                <form action="evenementdesinscrit.php" method=post >

<input type="submit" value="<?php echo <p class="myButton">annuler ma participation</p> ?>"/>
